...
void loop()
{
  ...
  Serial.println("Starting bendyDash.run()");
  if (bendyDash.run() == true)
  {
    Serial.println("bendyDash.run() completed successfully");
    uint64_t sleepDuration = bendyDash.getSleepDuration();
